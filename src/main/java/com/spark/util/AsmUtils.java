...
/**
 * A collection of various ASM utility methods
 *
...
public class AsmUtils implements Opcodes {
  ...
  public static ClassNode getClass(String className, final ClassNode[] nodes) {
  ...
  public static MethodNode getMethod(final String className, final ClassNode[] nodes, final String methodName, final String methodDesc) {
    return getMethod(getClass(className, nodes), methodName, methodDesc);
  }
